...
$(PROGRAM_NAME): main.o interface.o material.o object.o objLoader.o particle.o
	$(CC) -o $@ $^ $(CFLAGS) $(LDFLAGS)

main.o: interface.o material.o object.o

interface.o: material.o object.o

object.o: material.o objLoader.o particle.o
